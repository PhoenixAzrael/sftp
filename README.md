...
![Docker Automated build](https://img.shields.io/docker/automated/phoenixazrael/sftp.svg) ![Docker Build Status](https://img.shields.io/docker/build/phoenixazrael/sftp.svg) ![Docker Stars](https://img.shields.io/docker/stars/phoenixazrael/sftp.svg) ![Docker Pulls](https://img.shields.io/docker/pulls/phoenixazrael/sftp.svg)

![OpenSSH logo](https://raw.githubusercontent.com/phoenixazrael/sftp/master/openssh.png "Powered by OpenSSH")
...
```
docker run -p 22:22 -d phoenixazrael/sftp foo:pass:::upload
```
...
docker run \
    ...
    -p 2222:22 -d phoenixazrael/sftp \
    foo:pass:1001
```
...
Tip: you can use [phoenixazrael/makepasswd](https://hub.docker.com/r/phoenixazrael/makepasswd/) to generate encrypted passwords:  
`echo -n "your-password" | docker run -i --rm phoenixazrael/makepasswd --crypt-md5 --clearfrom=-`
...
**NOTE:** Using `mount` requires that your container runs with the `CAP_SYS_ADMIN` capability turned on. [See this answer for more information](https://github.com/phoenixazrael/sftp/issues/60#issuecomment-332909232).
